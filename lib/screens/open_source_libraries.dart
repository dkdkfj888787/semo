...
import '../models/open_source_library.dart';
...
class _OpenSourceLibrariesState extends State<OpenSourceLibraries> {
  List<OpenSourceLibrary> _libraries = [
    ...
    OpenSourceLibrary(name: 'flutter_localizations', pubPath: '/flutter_localizations'),
    ...
    OpenSourceLibrary(name: 'intl', pubPath: '/intl'),
